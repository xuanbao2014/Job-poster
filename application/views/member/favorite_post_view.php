...
<div><h4>&nbsp;&nbsp;<?=lang('zhidian_member_favorite')?>
...
<!--					<td style="text-align:center;"><a data-toggle="modal" href="/member/updatepost/<?=$row['id']?>"><span class="glyphicon glyphicon-edit"></span></a></td>//-->
					<td style="text-align:center;"><a data-toggle="modal" href="/member/deleteFavorite/<?=$row['id']?>" data-target="#deleteModal"><span class="glyphicon glyphicon-trash"></span></a></td>
				</tr>
				<?php endforeach;?>
			<?php endif;?>
		</tbody>
