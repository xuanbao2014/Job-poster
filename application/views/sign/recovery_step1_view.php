...
<div class="container">
	...
	<div class="col-xs-4 col-xs-offset-4" style="margin-top:100px;">
		<div>
			...
			<form class="<?php if($this->session->flashdata('msg_succ')){echo 'hidden';}?>" method="post" accept-charset="utf-8" action="/sign/recovery_step1" role="form" novalidate>
			  <div class="form-group">
				<label><?=lang('zhidian_email')?></label>
				<input type="email" class="form-control" name="email" autofocus>
			  </div>
			  <button type="submit" class="btn btn-primary btn-sm"><?=lang('zhidian_send')?></button>
			</form>
		</div>
	</div>
</div>
